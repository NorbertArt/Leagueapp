let mysql,cors,express,bodyParser,dotenv,path,multer,Leagues,Teams,knex,Players;_00b‍.w("mysql",[["default",["mysql"],function(v){mysql=v}]]);_00b‍.w("cors",[["default",["cors"],function(v){cors=v}]]);_00b‍.w("express",[["default",["express"],function(v){express=v}]]);_00b‍.w("body-parser",[["default",["bodyParser"],function(v){bodyParser=v}]]);_00b‍.w("dotenv",[["default",["dotenv"],function(v){dotenv=v}]]);_00b‍.w("path",[["default",["path"],function(v){path=v}]]);_00b‍.w("multer",[["default",["multer"],function(v){multer=v}]]);_00b‍.w("./src/models/League",[["default",["Leagues"],function(v){Leagues=v}]]);_00b‍.w("./src/models/Team",[["default",["Teams"],function(v){Teams=v}]]);_00b‍.w("./src/config/database",[["default",["knex"],function(v){knex=v}]]);_00b‍.w("./src/models/players",[["default",["Players"],function(v){Players=v}]]);
...
app.post('/imageupload', async (req, res) => {	
    ...
    }catch (err) {_00b‍.g.console.log(err)}
})
	...
	var fs=require('fs');
			...
			fs.unlink(filePath,deleteFileCallback);
				...
				function deleteFileCallback(error){
					...
					_00b‍.g.console.log(error.message);} else{console.log('Deleted Successfully ..');}									 
					}    
})
